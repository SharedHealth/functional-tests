...
function VitalsEntry(root,detail,entries)
{
    var vitals_entry = VitalsSectionEntry(root,detail,"Vitals", entries);
    return vitals_entry;
}

function BloodPressureEntry(root,detail, entries)
{
...
function SystolicEntry(root,detail)
{
...
function DiastolicEntry(root,detail)
{
...
function PulseEntry(root,detail)
{
    var pulse_entry = new SubVitalsEntry(root,detail,'Pulse');
    return pulse_entry;
};

function TemperatureEntry(root,detail)
{
