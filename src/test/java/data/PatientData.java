...
public class PatientData {
    ...
    public  Patient newPatient1 = new Patient.PatientBuilder().firstName("A" + id1)
    ...
    private  String id2 = String.valueOf(System.currentTimeMillis()).substring(7);
    public  Patient newPatient2 = new Patient.PatientBuilder().firstName("A" + id2)
            .lastName("ATEST").gender("Male").dateOfBirth("01-03-2000").address(defaultAddress)
    ...
    public  Patient newPatient3 = new Patient.PatientBuilder().firstName("A" + id3)
            .lastName("ATEST").gender("Male").dateOfBirth("01-03-2000").address(defaultAddress)
    ...
    public  Patient defaultPatient = new Patient.PatientBuilder().firstName("PTHREE")
    ...
    public  Patient patientForConsultation = new Patient.PatientBuilder().firstName("A902213")
            .lastName("ATEST").gender("Male").dateOfBirth("01-03-2000").address(defaultAddress)
